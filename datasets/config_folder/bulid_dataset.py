...
Usage:
    ...
    6- IMPORTANT
        ...
        ***Please put the images of for test set only in images folder at this time.
        ...
        ####
            This is a kind o limitation of program but this strategy has been followed to keep the test set always similar for every model or version of training, while, changing the train or validation set. So that the evaluation of every model is done on the same test set.
...
class DataPreparationXml:
    ...
    def __init__(self):
        ...
        ap.add_argument(
            "-s", "--split", type=float, default=1.0, help="train and val split"
        )
        ap.add_argument(
            "-b", "--splittest", type=float, default=0.0, help="val and test split"
        )
