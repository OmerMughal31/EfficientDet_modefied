...
"""
This programe file will help you to examin your dataset quickly such as
    
    1- How does your dataset look like?
        As, head of dataset will display some rows of dataset to let you know
    2- How many unique images are there is your dataset?
        ...
        thetefore, to see the length of each file you need this program
    3- How many unique classes you have in my dataset?
        As, I have mannualy labelled my dataset but there could be mistake in labelling
        therefore, I am checking again to confirm that is everything has been labelled correctly. Furthermore, this programe file will tell me that how many instances for each class have been labelled.
        for instance,
        drone = 125
        person = 580
    4- Are the extracted labels for training of neural network correct?
        ...
        then, it will draw the annotations on loaded images and save it to your directory.
...
class VarifyLabels:
    ...
    ** you have to give the file name for test tarin and val dataset annotations mannualy
    ...
    """
    Targeted directory will be specified autonomously and analysed images will be saved there
    """
    ...
    """
    This function is responsible for the bar chart for better visual
    
    Inputs: 
        1- extracted details for size of objects which is usually the area of object
        2- Position details of object in the image which is a center point of every object
    
    Outputs:
        1- Bar chart and lists of statistics regarding inputs
    ...
    """
    This function is responsible to read some example images from dataset, extract the concerned annotations from dataframe and draw them on images arround the objects.
    
    Inputs:
        1- dataframe of provided csv file
    Outputs:
        1- Write the files in directory named "verfied_images" for real time visuals for confirmation
        
    """
    def draw_boxes(self, dataset_dframe):
        for n,line in enumerate(dataset_dframe):
    ...
    """
    Main function where, draw-box() and plot_box_statistics() functions have been called
